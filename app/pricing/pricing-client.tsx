...
const creditPacks = [
  { id: 'starter',      name: '入门包', credits: 20,  price: '$1.9',  unitPrice: '$0.095/次', highlight: false },
  { id: 'standard',     name: '标准包', credits: 60,  price: '$4.9',  unitPrice: '$0.082/次', highlight: false },
  { id: 'value',        name: '超值包', credits: 150, price: '$9.9',  unitPrice: '$0.066/次', highlight: true  },
  { id: 'professional', name: '专业包', credits: 400, price: '$19.9', unitPrice: '$0.050/次', highlight: false },
]
